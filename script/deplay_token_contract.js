...
async function main() {
    ...
    const accountKeyTest = PrivateKey.fromStringED25519(process.env.OPERATOR_KEY);

    const treasuryAccountId = AccountId.fromString(process.env.ALICE_ID);
    const treasuryKey = PrivateKey.fromStringED25519(process.env.ALICE_PVKEY);
